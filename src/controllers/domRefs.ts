...
export function queryDomRefs() {
  ...
  return {
    ...
    npcCharacterSection: mustQuery<HTMLElement>("#npc-character-section"),
    addNpcButton: mustQuery<HTMLButtonElement>("#add-npc-button"),
    npcCharacterList: mustQuery<HTMLDivElement>("#npc-character-list"),
